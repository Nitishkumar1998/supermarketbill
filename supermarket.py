...
def bill_cal():
    ...
    while a:
        ...
        if choice in choices:
            d = {'dal':23,'oil':35,'mirchi':33,'shampoo':98, 'soap':45,'Bodyspray':120,'Basmatirice':120}
            if choice == 1: 
                c=1
                for i,j in d.items():
                    print('\t',c,'.',i,'₹',j)
    ...
    return total_price,'Thank you, Please Visit to VINEELA Stores again.',list_item_price
...
if total !=0:
    ...
    print('''
            ...
            MANCHIKALLU,522421
          -----------------------
        CIN NO   : L51900MH200PLC1245
        GSTIN    : 36AABBA8432H1ZA
        FSSAI NO : 1234567900865
      ===================================
    ''')
